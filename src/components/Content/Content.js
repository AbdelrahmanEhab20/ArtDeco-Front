        ...
        <div className="content">
            ...
            <div className="content__single">
                <Single
                    ...
                    content="Find professional company you can trust by browsing their samples of previous work and reading their profile reviews."
                />
                <Single
                    src="https://www.f-cdn.com/assets/main/en/assets/home/benefits/view-bids-v2.svg"
                    title="View bids"
                    content="Receive free bids from our talented companies within seconds."
                />
                <Single
                    src="https://www.f-cdn.com/assets/main/en/assets/home/benefits/live-chat-v2.svg"
                    title="Live chat"
                    content="You can live chat with your company to get constant updates on the progress of your work."
                />
            </div>
            <div className="content__single">
                <Single
